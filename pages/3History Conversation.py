    ...
    try:
        with connection.cursor() as cursor:
            if role == 'admin':
                ...
                sql = "SELECT chat_count, user_name, patient_details, conversation_score, session_id, performance_feedback FROM user_chat_history where publish_conversation =  1 or user_id =  %s"
            else:
